...
for ticker, name in tickers.items():
    ...
    report = ai_db.get("reports", {}).get(ticker, "🤖 正在連線地緣政治策略家...")
    ...
    # 核心 HTML 佈局 (嚴格校對閉合標籤)
    st.markdown(f"""
    <div style="background:#fff9f9; border-left:12px solid #e53935; padding:20px; border-radius:12px; margin-bottom:30px; border:1px solid #ffdde0; box-shadow: 2px 4px 10px rgba(0,0,0,0.05);">
        ...
        <div style="display:flex; gap:20px; align-items: stretch;">
            ...
            <div style="flex:1.8; display:flex; flex-direction:column; justify-content:space-between;">
                <div>
                    <b style="font-size:1.1em; color:#333;">🧠 智權診斷 (AI 版)：</b>
                    <div style="margin-top:10px; font-size:1.02em; line-height:1.6; color:#444; white-space: pre-wrap;">{report}</div>
                </div>
            ...
            <div style="flex:1; background:white; border:1px solid #eee; border-radius:12px; padding:20px; box-shadow: inset 0 0 5px rgba(0,0,0,0.02); min-width:280px;">
